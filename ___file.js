    ...
    var tableHTML = `
        <table>
            <tr  style="border: 1px solid black;">
                <td  style="border: 1px solid black;">파일 명</td>
                <td  style="border: 1px solid black;">${name}</td>
            </tr>
            <tr  style="border: 1px solid black;">    
                <td style="border: 1px solid black;">파일 크기</td>
                <td style="border: 1px solid black;">${addCommasToInteger(size)} bytes</td>
            </tr>
            <tr style="border: 1px solid black;">
                <td style="border: 1px solid black;">해시값 (SHA256)</td>
                <td style="border: 1px solid black;">${sha256_hash}</td>
            </tr>
        </table>
    `;
